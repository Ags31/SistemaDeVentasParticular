...
{
    public class LO_Dato
    {

        private static LO_Dato _instancia = null;
        ...
        public static LO_Dato Instancia
        {

            get
            {
                if (_instancia == null) _instancia = new LO_Dato();
                return _instancia;
            }
        }
        ...
        public int Guardar(Datos objeto, out string mensaje)
        {
            ...
            try
            {
                ...
                using (SQLiteConnection conexion = new SQLiteConnection(Conexion.cadena))
                {
                    ...
                    cmd.Parameters.Add(new SQLiteParameter("@pruc", objeto.DNI));
